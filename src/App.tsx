        ...
        <Flex marginTop="5">
          <NumberInput
            ...
            onChange={(val) => {
              ...
              if (first) {
                const firstResult = Number(val) * first.quote['USD'].price;

                setSecondValueYouGet(
          ...
          <Flex flexDirection={'column'}>
            <NumberInput
              ...
              onChange={(val) => {
                ...
                if (first) {
                  const secondResult = Number(val) / first.quote['USD'].price;

                  setFirstValue(Math.round(Number(secondResult) * 100) / 100);
                }
              }}
            >
              <NumberInputField />
